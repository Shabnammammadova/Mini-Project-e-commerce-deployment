  ...
  return (
    ...
    <div>
      <div className="w-72 bg-white shadow-md rounded-xl duration-500">
        <div className='bg-[#F3E6DA] h-[300px] flex items-center justify-center rounded-t-xl'>
        ...
        <div className='px-4 py-1 w-72 flex items-center gap-2 rounded-b-xl bg-[#F3E6DA]'>
